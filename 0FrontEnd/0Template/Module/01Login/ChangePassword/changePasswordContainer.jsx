                            ...
                            <div className={"row"}>
                                <div className={"col-lg-6 col-md-8 col-sm-10 col-xs-12 offset-lg-3 offset-md-2 offset-sm-1"}>
                                    ...
                                    <div className="input-group form-group">
                                        <FieldPassword name={"old_password"} placeholder={"********"}/>
                                        <ErrorMessage name={"old_password"} component="div" className={"errorMessage"}/>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <br />
                                        <input type="submit" value="CHANGE PASSWORD" className="btn changepass_btn btn-primary form-control"/>
                                    </div>
                                </div>
                            </div>
                        </Form>
...
const ChangePasswordFooter = function (props) {
    return (
        <div className="changepass_footer">
        </div>
    )
}
