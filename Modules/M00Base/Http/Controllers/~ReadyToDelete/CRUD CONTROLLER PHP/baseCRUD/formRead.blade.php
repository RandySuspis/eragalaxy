...
$sideMenuObj = [
    ...
    'Agent' =>
        ['title' => 'Agent', 'leftIcon' => 'fa-dashboard', 'rightIcon' => 'fa-angle-left', 'url' => '#', 'submenus' =>
            [
                0 => ['title' => 'View','leftIcon' => 'fa-circle-o','rightIcon' => 'fa-angle-left','url' => 'king'],
                1 => ['title' => 'Add','leftIcon' => 'fa-circle-o','rightIcon' => 'fa-angle-left','url' => 'king'],
            ]
        ],
    'Komisi' =>
        ['title' => 'Komisi', 'leftIcon' => 'fa-edit', 'rightIcon' => 'fa-angle-left', 'url' => '#', 'submenus' =>
            [
                0 => ['title' => 'View','leftIcon' => 'fa-circle-o','rightIcon' => 'fa-angle-left','url' => 'king'],
                1 => ['title' => 'Add','leftIcon' => 'fa-circle-o','rightIcon' => 'fa-angle-left','url' => 'king'],
            ]
        ],
    'Report' => ['title' => 'Report', 'leftIcon' => 'fa-book', 'rightIcon' => 'fa-angle-left', 'url' => '#'],
    'Lain-Lain' => ['title' => 'Lain-Lain', 'leftIcon' => 'fa-table', 'rightIcon' => 'fa-angle-left', 'url' => '#'],
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src={{Theme::url("img/avatar5.png")}} class="user-image" alt="User Image">
