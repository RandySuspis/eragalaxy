...
class CreateTransactionPropertyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transaction_property', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('transaction_property');
    }
}
